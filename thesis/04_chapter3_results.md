...
**Сравнение объясняющей силы моделей.** На первом этапе три спецификации (М1–М3) оценены на полном периоде 2017–2025 (n = 422) методом наименьших квадратов с HAC-стандартными ошибками (Newey–West, h = 5). Сводные показатели объясняющей силы приведены в таблице 3.1.
